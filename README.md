[![Build Status](https://github.com/gap-packages/example/workflows/CI/badge.svg?branch=master)](https://github.com/gap-packages/example/actions?query=workflow%3ACI+branch%3Amaster)
